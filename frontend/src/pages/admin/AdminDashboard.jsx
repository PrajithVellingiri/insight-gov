...
export default function AdminDashboard() {
  ...
  const { stats, charts, mapData } = data || { stats: {}, charts: {} };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-1 pb-2 flex flex-col">
          <div className="px-4 pt-3 pb-2"><h2 className="section-title !mb-0">Geographic Distribution</h2></div>
          <div className="flex-1 min-h-[300px]">
            <PetitionMap petitions={mapData || []} role="admin" height="100%" />
          </div>
        </div>
      </div>
    </div>
