"""
backend/services/embedding_providers/gemini.py – Gemini text embedding provider for backend RAG.
...
class GeminiEmbeddingProvider(BaseEmbeddingProvider):
    ...
    def __init__(self, api_key: str, model: str = "gemini-embedding-001", base_url: str = "") -> None:
        ...
        if not self.api_key:
            logger.warning("Gemini API key is empty for backend embeddings.")
        else:
            try:
